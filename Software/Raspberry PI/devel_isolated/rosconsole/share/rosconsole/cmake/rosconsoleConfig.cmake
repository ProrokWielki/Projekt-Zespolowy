...
if("TRUE" STREQUAL "TRUE")
  set(rosconsole_SOURCE_PREFIX /mnt/dav/Projekt/Software/Raspberry PI/src/ros_comm/rosconsole)
  set(rosconsole_DEVEL_PREFIX /mnt/dav/Projekt/Software/Raspberry PI/devel_isolated/rosconsole)
...
if(NOT "/mnt/dav/Projekt/Software/Raspberry PI/src/ros_comm/rosconsole/include;/usr/include " STREQUAL " ")
  set(rosconsole_INCLUDE_DIRS "")
  set(_include_dirs "/mnt/dav/Projekt/Software/Raspberry PI/src/ros_comm/rosconsole/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/dav/Projekt/Software/Raspberry PI/src/ros_comm/rosconsole/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rosconsole_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole;rosconsole_log4cxx;rosconsole_backend_interface;/usr/lib/arm-linux-gnueabihf/liblog4cxx.so;/usr/lib/arm-linux-gnueabihf/libboost_regex.so;/usr/lib/arm-linux-gnueabihf/libboost_system.so;/usr/lib/arm-linux-gnueabihf/libboost_thread.so;/usr/lib/arm-linux-gnueabihf/libpthread.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /mnt/dav/Projekt/Software/Raspberry PI/devel_isolated/rosconsole/lib;/opt/ros/indigo/lib)
