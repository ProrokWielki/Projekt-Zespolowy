...
if("TRUE" STREQUAL "TRUE")
  set(roslang_SOURCE_PREFIX /mnt/dav/Projekt/Software/Raspberry PI/src/ros/roslang)
  set(roslang_DEVEL_PREFIX /mnt/dav/Projekt/Software/Raspberry PI/devel_isolated/roslang)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roslang' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/dav/Projekt/Software/Raspberry PI/src/ros/roslang/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /mnt/dav/Projekt/Software/Raspberry PI/devel_isolated/roslang/lib;/opt/ros/indigo/lib)
