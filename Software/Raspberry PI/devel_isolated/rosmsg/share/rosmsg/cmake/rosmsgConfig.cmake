...
if("TRUE" STREQUAL "TRUE")
  set(rosmsg_SOURCE_PREFIX /mnt/dav/Projekt/Software/Raspberry PI/src/ros_comm/rosmsg)
  set(rosmsg_DEVEL_PREFIX /mnt/dav/Projekt/Software/Raspberry PI/devel_isolated/rosmsg)
  set(rosmsg_INSTALL_PREFIX "")
  set(rosmsg_PREFIX ${rosmsg_DEVEL_PREFIX})
else()
  set(rosmsg_SOURCE_PREFIX "")
  set(rosmsg_DEVEL_PREFIX "")
  set(rosmsg_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosmsg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/dav/Projekt/Software/Raspberry PI/src/ros_comm/rosmsg/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /mnt/dav/Projekt/Software/Raspberry PI/devel_isolated/rosmsg/lib;/opt/ros/indigo/lib)
