...
if("TRUE" STREQUAL "TRUE")
  set(message_runtime_SOURCE_PREFIX /mnt/dav/Projekt/Software/Raspberry PI/src/message_runtime)
  set(message_runtime_DEVEL_PREFIX /mnt/dav/Projekt/Software/Raspberry PI/devel_isolated/message_runtime)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'message_runtime' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/dav/Projekt/Software/Raspberry PI/src/message_runtime/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /mnt/dav/Projekt/Software/Raspberry PI/devel_isolated/message_runtime/lib;/opt/ros/indigo/lib)
