...
if("TRUE" STREQUAL "TRUE")
  set(rostest_SOURCE_PREFIX /mnt/dav/Projekt/Software/Raspberry PI/src/ros_comm/rostest)
  set(rostest_DEVEL_PREFIX /mnt/dav/Projekt/Software/Raspberry PI/devel_isolated/rostest)
  set(rostest_INSTALL_PREFIX "")
  set(rostest_PREFIX ${rostest_DEVEL_PREFIX})
else()
  set(rostest_SOURCE_PREFIX "")
  set(rostest_DEVEL_PREFIX "")
  set(rostest_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "/mnt/dav/Projekt/Software/Raspberry PI/src/ros_comm/rostest/include;/usr/include " STREQUAL " ")
  set(rostest_INCLUDE_DIRS "")
  set(_include_dirs "/mnt/dav/Projekt/Software/Raspberry PI/src/ros_comm/rostest/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rostest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/mnt/dav/Projekt/Software/Raspberry PI/src/ros_comm/rostest/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(rostest_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/arm-linux-gnueabihf/libboost_system.so;/usr/lib/arm-linux-gnueabihf/libboost_thread.so;/usr/lib/arm-linux-gnueabihf/libpthread.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /mnt/dav/Projekt/Software/Raspberry PI/devel_isolated/rostest/lib;/opt/ros/indigo/lib)
